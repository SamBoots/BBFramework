...
namespace BB
{
	...
	//Default types
	typedef BB::MemoryArena<BB::allocators::LinearAllocator, BB::ThreadPolicy::Single_Thread> LinearAllocator_t;
	typedef BB::MemoryArena<BB::allocators::FreelistAllocator, BB::ThreadPolicy::Single_Thread> FreeListAllocator_t;
	typedef BB::MemoryArena<BB::allocators::POW_FreelistAllocator, BB::ThreadPolicy::Single_Thread> POW_FreeListAllocator_t;
